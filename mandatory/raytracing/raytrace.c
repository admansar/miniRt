...
/*   Updated: 2023/08/28 20:07:49 by selkhadr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//diff[0] is diffuse,  diff[1] is the ambient and diff[2] is the specular
int	raytracing_shape(t_all *all, t_3d_point direction)
{
	...
	color = produit_3d_point_par_cst(vec3(diff[1] + diff[0],
				diff[1] + diff[0],
				diff[1] + diff[0]), 
